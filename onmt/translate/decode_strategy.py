...
class DecodeStrategy(object):
    ...
    def __init__(self, pad, bos, eos, batch_size, parallel_paths,
        ...
        self.output_states = [[] for _ in range(batch_size)]
    ...
    def initialize(self, memory_bank, src_lengths, src_map=None, device=None,
        ...
        # 存活数据中对应哪些样本
        self.alive_example_ids = torch.LongTensor(
            [batch_idx for batch_idx in range(self.batch_size)]
        ).type_as(self.alive_seq)
